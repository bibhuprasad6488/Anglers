<nav class="navbar navbar-expand-lg navbar-dark tbb2 fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse d-none d-lg-flex">
            <ul class="navbar-nav ms-auto align-items-lg-center my_menu">
                <li class="nav-item"><a class="nav-link" style="background: #fff; color:#000;" href="tel:{{ $siteSetting->contact_phone }}">
                        ...
                        <span class="header-phone">{{ $siteSetting->contact_phone }}</span>
                    </a></li>
            </ul>
        </div>
    </div>

<nav class="sb-topnav navbar navbar-expand navbar-dark ">
    ...
    <a class="navbar-brand ps-3"
        href="{{ route('admin.dashboard') }}">{{ Auth::guard('admin')->user()->name ? Auth::guard('admin')->user()->name : '' }}</a>
    <!-- Sidebar Toggle-->
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" id="navbarDropdown" href="javascript:;" role="button"
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item"
                        href="{{ route('admin.profile-setting.show', Auth::guard('admin')->user()->id) }}">Profile
                        Settings</a></li>

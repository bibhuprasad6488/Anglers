                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <textarea name="short_desc" id="short_desc" class="form-control" rows="3" placeholder="Short desc">{{ $blog->short_desc }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row  mb-2">
                                    <label for="" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <textarea name="long_desc" id="long_desc" class="form-control" rows="3">{{ $blog->long_desc }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row  mb-2">
                                    <label for=""
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        ...
                                        <img class="my-2"
                                            @if ($blog && $blog->blog_img) src="{{ $blog->blog_img }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group  row mb-2">
                                    <label for="" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">
                                        ...
                                        Description</label>
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <textarea name="meta_desc" id="meta_desc" class="form-control" rows="3" placeholder="Meta Description">{{ $blog->meta_desc }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group  row mb-2">
                                    <label for="" class="col-md-3 d-flex justify-content-end col-sm-3 col-xs-12">
                                        ...
                                        Keywords</label>
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <textarea name="meta_key" id="meta_key" class="form-control" rows="3" placeholder="Meta Keys">{{ $blog->meta_key }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>

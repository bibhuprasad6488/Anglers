                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row  mb-2">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <img @if (optional($property)->thumbnail) src="{{ optional($property)->thumbnail }}"
                                        @else src="" style="display: none;" @endif
                                            alt="preview" id="thumbnailPreview" class="w-100">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row  mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input type="text" name="minimum_diposit" id="minimum_diposit"
                                            ...
                                            value="{{ $property->minimum_diposit ?? (old('minimum_diposit') ?? 200) }}"
                                ...
                                <div class="form-group row  mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input type="text" name="price_per_pet" id="price_per_pet"
                                            class="form-control numeric-only"
                                            value="{{ $property->price_per_pet ?? 50 }}" placeholder="Price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row  mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input type="text" name="number_of_bed" id="number_of_bed"
                                            class="form-control numeric-only" value="{{ $property->number_of_bed }}"
                                ...
                                <div class="form-group row  mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input type="text" name="max_adult" id="max_adult"
                                            class="form-control numeric-only" value="{{ $property->max_adult }}"
                                ...
                                <div class="form-group row  mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input type="text" name="max_child" id="max_child"
                                            class="form-control numeric-only" value="{{ $property->max_child }}"
                                ...
                                <div class="form-group d-none row  mb-2">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input type="text" name="max_pet" id="max_pet"
                                            class="form-control numeric-only" value="{{ $property->max_pet ?? 2 }}"
                                            placeholder="Max pet">
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
